...
export default function HomePage() {
  ...
  return (
    <div ref={ref} className="relative bg-black text-white min-h-screen overflow-hidden font-sans">
      ...
      <header className="flex justify-between items-center p-6 fixed w-full backdrop-blur-md bg-black/50 z-50">
        ...
        <nav>
          <ul className="flex space-x-6 text-sm">
            <li className="hover:text-blue-400 cursor-pointer" onClick={() => scrollToSection('home')}>Home</li>
            <li className="hover:text-blue-400 cursor-pointer" onClick={() => scrollToSection('about')}>About us</li>
            <li className="border border-blue-400 px-4 py-2 rounded-md cursor-pointer hover:bg-blue-400 hover:text-black" onClick={() => scrollToSection('contact')}>Contact Us</li>
          </ul>
        </nav>
      </header>
      ...
      <section id="home" className="flex flex-col items-center text-center pt-40 pb-20">
