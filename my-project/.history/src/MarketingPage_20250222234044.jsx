...
export default function HomePage() {
  ...
  return (
    <div 
      ref={ref} 
      className="relative bg-black text-white min-h-screen overflow-hidden font-sans bg-[url('/bg-image.jpg')] bg-cover bg-center"
    >
      {/* Header */}
      ...
      <section className="p-20 text-center">
        ...
        <p className="text-gray-300 max-w-2xl mx-auto mt-4">POWERHOUSE is a smart home platform designed to help you track, automate, and reduce energy consumption effortlessly.</p>
      </section>
