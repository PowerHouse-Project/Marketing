<div>
  ...
  <style
    dangerouslySetInnerHTML={{
      __html:
        "body {margin:0; padding:0; font-family: Arial, sans-serif; background: url('/lovepik-digital-tech-aesthetic-background-image_400076508.jpg') no-repeat center center fixed;\n            background-size: cover;\n            color: white;\n            overflow-x: hidden;\n        }\n        nav {\n            position: fixed;\n            top: 0;\n            right: 20px;\n            display: flex;\n            gap: 20px;\n            background: rgba(0, 0, 0, 0.5);\n            backdrop-filter: blur(10px);\n            padding: 10px 20px;\n            border-radius: 10px;\n            z-index: 1000;\n        }\n        nav button {\n            background: transparent;\n            border: none;\n            color: white;\n            font-size: 18px;\n            cursor: pointer;\n            padding: 10px;\n        }\n        .section {\n            height: 100vh;\n            display: flex;\n            justify-content: center;\n            align-items: center;\n            text-align: center;\n            flex-direction: column;\n            padding: 50px;\n        }\n        .parallax {\n            background: rgba(255, 255, 255, 0.1);\n            backdrop-filter: blur(10px);\n            border-radius: 20px;\n            padding: 40px;\n            width: 80%;\n            max-width: 900px;\n        }\n        .features-container {\n            display: flex;\n            justify-content: space-between;\n            flex-wrap: wrap;\n            max-width: 1000px;\n            margin-top: 40px;\n        }\n        .feature-box {\n            background: rgba(255, 255, 255, 0.1);\n            backdrop-filter: blur(10px);\n            padding: 20px;\n            border-radius: 10px;\n            flex: 1;\n            margin: 10px;\n            text-align: center;\n            display: flex;\n            flex-direction: column;\n            align-items: center;\n        }\n        .feature-box img {\n            width: 50px;\n            height: 50px;\n            margin-bottom: 10px;\n        }\n        .blog-container {\n            display: flex;\n            justify-content: center;\n            gap: 20px;\n            margin-top: 40px;\n        }\n        .blog-box {\n            background: rgba(255, 255, 255, 0.1);\n            backdrop-filter: blur(10px);\n            padding: 20px;\n            border-radius: 10px;\n            width: 300px;\n            text-align: center;\n        }\n        .newsletter {\n            margin-top: 40px;\n            text-align: center;\n        }\n        .footer {\n            text-align: center;\n            padding: 20px;\n            background: rgba(0, 0, 0, 0.5);\n            backdrop-filter: blur(10px);\n        }\n    ",
    }}
  />
  <nav>
