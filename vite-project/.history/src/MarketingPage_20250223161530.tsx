    ...
    <div className="app">
      ...
      <Section id="about" title="Discover Our Story">
        ...
        <div className="features-container">
          ...
          <FeatureBox imgSrc="/src/logo.png" title="Smart Automation" text="We build trust by keeping our promises and doing what works for the Nation and our Customers to ensure the resilience of our digital ecosystem" />
        </div>
      </Section>
