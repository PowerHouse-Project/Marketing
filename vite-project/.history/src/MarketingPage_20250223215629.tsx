...
const App = () => {
  ...
  return (
    <div className="app">
      ...
      <section id="home" className="section full-width-black">
        <div className="parallax">
          <h1 className="center-text">See It in Action</h1>
        </div>
      </section>
...
<section id="about" className="section black-background">
  <div className="glass-box left-aligned">
    <h2>Discover Our Story</h2>
          <p>
