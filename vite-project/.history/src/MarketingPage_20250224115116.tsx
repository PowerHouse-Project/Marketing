  ...
  return (
    <div className="app">
      ...
      <nav className="navbar">
        <div className="logo bold">PowerHouse</div>
      ...
      {/* About Section */}
      <section id="about" className="about-section full-width-black">
        <div className="about-content center-content">
      ...
      <section id="features" className="features-section">
        <div className="features-container center-content">
      ...
      <section id="newsletter" className="newsletter-section">
        <div className="glass-box newsletter-box center-content">
      ...
      {/* Contact Section */}
      <section id="contact" className="contact-section full-width-black">
...
const FeatureBox = ({ imgSrc, title, text }: FeatureBoxProps) => (
  <div className="feature-box center-content">
