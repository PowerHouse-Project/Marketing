        ...
        <div className="App">
            ...
            <section id="features" className="section">
                <div className="features-container">
                    <FeatureBox imgSrc="/src/log" title="Real-Time Energy Tracking" text="We are always one step ahead; we challenge convention and push the boundaries of what can be achieved" />
