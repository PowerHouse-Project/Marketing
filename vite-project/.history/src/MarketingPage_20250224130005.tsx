        ...
        <div className="App">
            ...
            <section id="features" className="section">
                <div className="features-container">
                    ...
                    <FeatureBox imgSrc="src/bx-universal-access.svg" title="Smart Automation" text="Smart Automation" text="We build trust by keeping our promises and doing what works for our Customers to ensure the resilience of our digital ecosystem" />
                </div>
            </section>
        </div>
    );
