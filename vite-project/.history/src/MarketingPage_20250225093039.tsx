...
const App = () => {
    ...
    <div className="features-grid">
        <FeatureBox imgSrc="src/carbon_gateway-security.png" title="Real-Time Energy Tracking" text="Monitor and optimize your energy usage effortlessly." />
        <FeatureBox imgSrc="src/carbon_gateway-security.png" title="User-Friendly Interface" text="Easy-to-use platform with intuitive controls." />
        <FeatureBox imgSrc="src/carbon_gateway-security.png" title="Cost-Saving" text="Reduce your electricity bills with smart insights." />
        <FeatureBox imgSrc="src/carbon_gateway-security.png" title="Smart Automation" text="Automate your home for efficiency and convenience." />
    </div>
</section>
