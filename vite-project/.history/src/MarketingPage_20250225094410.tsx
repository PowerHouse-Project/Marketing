...
const App = () => {
    ...
    return (
        <div className="App">
            ...
            <div id="className="section-container">
    <h2 className="section-title">Experience Smart Living</h2>
    <div className="experience-grid">
        <div className="experience-card"></div>
            ...
            <div id="home" className="section-container">
                ...
                <p className="section-description">POWERHOUSE is a smart home platform designed to help you track, automate, and reduce energy consumption effortlessly. With real-time monitoring, smart automation, and cost-saving insights, POWERHOUSE optimizes your home’s energy use—saving you money while reducing your carbon footprint.
